...
public class MenuTelaInicialCoordenadorView extends Composite{
	...
	public MenuTelaInicialCoordenadorView(){
		...
		hpPainelNomeCoordenador.add(iAtividadesCoordenador);//add item
		...
		hpPainelCoordenadorEmAtividades.add(iParticipanteCoordenador);//add item
		...
		hpPainelLogoutCoordenador.add(iLogoSiteCoordenador);//add item
